...
namespace YahooFinApi.Console
{
    class Program
    {
        static void Main()
        {
            ...
            System.Console.WriteLine(client.DownloadDataAsync($"http://real-chart.finance.yahoo.com/table.csv?s={stock}&d=1&e=29&f=2016&g=d&a=0&b=29&c=1988&ignore=.csv").Result);
        }
    }
}
